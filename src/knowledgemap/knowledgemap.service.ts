...
export class KnowledgeMapService {
  private readonly nodes: KnowledgeNode[] = [
    {
      ...
      relatedNodes: ['JavaScript', 'Frontend Development'],
    ...
    },
    {
      ...
      relatedNodes: ['Node.js', 'Backend Development'],
      category: 'Programming',
    },
    {
      id: 3,
      ...
      relatedNodes: ['System Design', 'Distributed Systems'],
    ...
    },
    {
      ...
      relatedNodes: ['DevOps', 'Containerization'],
      category: 'DevOps',
    },
    {
      id: 5,
  ...
  update(
    id: number,
    updatedNode: Partial<KnowledgeNode>,
