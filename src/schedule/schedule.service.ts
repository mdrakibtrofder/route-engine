  ...
  private readonly schedule: ScheduleBlock[] = [
    {
      id: 1,
      time: '09:00 - 11:00',
      title: 'Deep Work: Kernel Development',
      type: 'Deep Work',
    ...
    },
    {
      ...
      type: 'Admin',
      description: 'Quarterly roadmap review and updates',
      status: 'upcoming',
    },
    {
      id: 6,
      ...
      type: 'Meetings',
      description: 'Requirements gathering for new features',
      status: 'upcoming',
    },
    {
      id: 7,
    ...
    },
    {
      ...
      type: 'Learning',
      description: 'Advanced containerization techniques',
      status: 'upcoming',
    },
    {
      id: 9,
