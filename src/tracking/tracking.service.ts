...
export class TrackingService {
  ...
  private objectives: Objective[] = [
    {
      ...
      keyResults: [
        ...
        {
          description: 'Set up content management',
          progress: 80,
          status: 'in-progress',
        },
        {
    ...
    },
    {
      ...
      keyResults: [
        {
          description: 'Finish advanced course',
          progress: 80,
          status: 'in-progress',
        },
        {
          description: 'Build 3 TypeScript projects',
          progress: 67,
          status: 'in-progress',
        },
        {
  ...
  updateObjective(
    id: number,
    updatedObjective: Partial<Objective>,
  ): Objective | undefined {
    const objectiveIndex = this.objectives.findIndex((o) => o.id === id);
    if (objectiveIndex > -1) {
      this.objectives[objectiveIndex] = {
        ...this.objectives[objectiveIndex],
        ...updatedObjective,
      };
