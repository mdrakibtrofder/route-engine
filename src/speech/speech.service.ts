...
export class SpeechService {
  private readonly speeches: Speech[] = [
    ...
    },
    {
      ...
      deliveries: [{ date: '2024-03-20', duration: '15min' }],
    },
    {
      id: 3,
      ...
      deliveries: [{ date: '2023-12-15', duration: '30min' }],
    },
    {
      id: 4,
      ...
      deliveries: [{ date: '2024-02-15', duration: '45min' }],
    },
    {
      id: 5,
      title: 'Customer Appreciation',
      script:
        'Our success would not be possible without our valued customers...',
      categories: ['Customer Relations'],
      deliveries: [{ date: '2024-04-01', duration: '20min' }],
    },
    {
      id: 6,
      ...
      deliveries: [{ date: '2024-05-10', duration: '25min' }],
    },
    {
      id: 7,
      ...
      deliveries: [{ date: '2024-06-05', duration: '18min' }],
    },
    {
      id: 8,
      ...
      deliveries: [{ date: '2024-03-30', duration: '40min' }],
    },
    {
      id: 9,
      ...
      deliveries: [{ date: '2024-04-15', duration: '35min' }],
    },
    {
      id: 10,
      ...
      deliveries: [{ date: '2024-02-28', duration: '22min' }],
    },
    {
      id: 11,
      ...
      deliveries: [{ date: '2024-04-30', duration: '28min' }],
    },
    {
      id: 12,
      ...
      deliveries: [{ date: '2024-07-01', duration: '15min' }],
    },
  ];
