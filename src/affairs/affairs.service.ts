  ...
  private readonly affairs: Affair[] = [
    {
      ...
      summary: "Keynotes on AI, quantum computing, and biotech. Major product announcements from industry leaders.",
      type: "Technological",
    },
    {
      id: 2,
      ...
      summary: "The agreement aims to reduce tariffs on goods and services, boosting economic growth.",
      type: "Economic",
    },
    {
      id: 3,
      ...
      summary: "Protests and demonstrations are being held in major cities, calling for policy changes.",
      type: "Social",
    },
    {
      id: 4,
      title: "New Environmental Regulations Proposed",
      details: "Governments propose stricter regulations to combat climate change.",
      source: "BBC News",
      link: "https://bbc.com/news",
      summary: "The regulations target carbon emissions from industrial activities and transportation.",
      type: "Political",
    },
  ];
